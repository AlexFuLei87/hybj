...
<html>
  ...
  <body>
    <s:form action="/cp/hybjSpecialAction_importSpecial.do" method="post" enctype="multipart/form-data">
      <br>
      <table border="0" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <s:file onchange="checkFile(this);" name="file" id='file' cssStyle="width:365px"></s:file>
