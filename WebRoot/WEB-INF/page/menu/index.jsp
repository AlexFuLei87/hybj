							...
							<table border="0" width="70%" id="table4">
								<tr>
									<td colspan="2" width="200">
										<font color="red"><s:fielderror name="error"/></font>
									</td>
								</tr>
									...
									<td>
										<table>
											<tr>
												...
												<td>
													<img src="${pageContext.request.contextPath}/image.jsp" id="checkNumberImage" name="checkNumberImage" height="20" style="cursor:hand" title="点击切换下一张图片" onclick="changeImage()"/>
												</td>
											</tr>
										</table>
									</td>
